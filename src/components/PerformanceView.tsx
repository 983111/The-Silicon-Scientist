...
const EXPERIMENTS = [
  { id: 'EXP-0042', name: 'Alpha-Node Eval', reliability: 94, efficiency: 82, convergence: 97, speed: 65, accuracy: 91, cost: 78 },
  { id: 'EXP-0041', name: 'Beta-Cluster Opt', reliability: 87, efficiency: 71, convergence: 85, speed: 88, accuracy: 83, cost: 92 },
  { id: 'EXP-0040', name: 'Graph-Traversal', reliability: 32, efficiency: 45, convergence: 28, speed: 42, accuracy: 38, cost: 55 },
  { id: 'EXP-0039', name: 'Gradient Search', reliability: 91, efficiency: 88, convergence: 89, speed: 72, accuracy: 86, cost: 81 },
  { id: 'EXP-0038', name: 'Neural Synapse', reliability: 68, efficiency: 74, convergence: 62, speed: 80, accuracy: 71, cost: 88 },
];

const PARAMS = ['reliability', 'efficiency', 'convergence', 'speed', 'accuracy', 'cost'] as const;
...
export function PerformanceView() {
  ...
  const [sortBy, setSortBy] = useState<typeof PARAMS[number]>('reliability');
